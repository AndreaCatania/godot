...
void godex::DynamicSystemInfo::add_resource(uint32_t p_resource_id, bool p_mutable) {
...
void godex::DynamicSystemInfo::add_component(uint32_t p_component_id, bool p_mutable) {
	const uint32_t index = resource_element_map.size() + query_element_map.size();
