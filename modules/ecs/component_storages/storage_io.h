...
/// pointer.
// Note, This utility was necessary because is not possible to have virtual
...
public:
	...
	template <class T>
	static void insert(Storage *p_storage, EntityIndex p_index, T p_data);
};

template <class T>
void StorageIO::insert(Storage *p_storage, EntityIndex p_index, T p_data) {
